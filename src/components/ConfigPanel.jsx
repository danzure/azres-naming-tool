                    ...
                    <div className="animate-in slide-in-from-top-4 duration-300">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            <div className={`p-4 rounded border ${isDarkMode ? 'bg-[#1b1a19] border-[#484644]' : 'bg-white border-[#edebe9] shadow-sm'}`}>
                                <div className="flex items-center gap-2 border-b pb-2 mb-3" style={{ borderColor: isDarkMode ? '#484644' : '#edebe9' }}>
                                ...
                                {/* Org Prefix within the left column */}
                                <div className="mt-4 pt-3 border-t" style={{ borderColor: isDarkMode ? '#484644' : '#edebe9' }}>
                                    <label className={`block text-[14px] font-semibold mb-2 ${isDarkMode ? 'text-white' : 'text-[#201f1e]'}`}>Org Prefix <span className={`font-normal ${isDarkMode ? 'text-[#a19f9d]' : 'text-[#605e5c]'}`}>(Optional)</span></label>
                            ...
                            {/* Right Column: Pattern Builder */}
                            <div className={`p-4 rounded border ${isDarkMode ? 'bg-[#1b1a19] border-[#484644]' : 'bg-white border-[#edebe9] shadow-sm'}`}>
                                <div className="flex items-center gap-2 border-b pb-2 mb-3" style={{ borderColor: isDarkMode ? '#484644' : '#edebe9' }}>
                                    <Edit3 className="w-4 h-4 text-[#0078d4]" />
                                    <h3 className={`text-[14px] font-semibold ${isDarkMode ? 'text-white' : 'text-[#201f1e]'}`}>Pattern Builder</h3>
                                </div>
                                <p className={`text-[12px] leading-relaxed mb-3 ${isDarkMode ? 'text-[#c8c6c4]' : 'text-[#605e5c]'}`}>
                                    Build your naming pattern using the <a href="https://learn.microsoft.com/azure/cloud-adoption-framework/ready/azure-best-practices/resource-naming" target="_blank" rel="noopener noreferrer" className="text-[#0078d4] hover:underline">CAF</a> format. Reorder components to match your standards.
                                </p>
